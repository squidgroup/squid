...
#'                       in order to learn and get more familiarized with the SQUID model and its sampling design (use the function \code{\link{runSQUIDapp}}).
#' 
#' @param input          A list of the model input parameters (see details).
#' @param plot           logical; If \code{FALSE} (default), \code{runSQUIDfct} does not include the simulation plots into the output list.
...
#'
#' @return
#' A \code{list} that includes a \code{data.frame} of the full data generated, a \code{data.frame} 
#' of the sampled data and six \href{https://cran.r-project.org/web/packages/ggplot2/index.html}{ggplot2} plots of the results if \code{plot} is \code{TRUE}.
#' 
#' The full and the sampled data could be accessed respectively by \code{output$full_Data} and \code{output$sampled_Data}.
#' The content of the columns in the the full and the sampled \code{data.frame} is described below:
#' 
#'   \itemize{
...
#'   }
#'   
#' \code{runSQUIDfct} returns a list that also includes a list (\code{$myPlot}) of six \href{https://cran.r-project.org/web/packages/ggplot2/index.html}{ggplot2} plots of the results. Note that the plots display only the data of the first trait, the first replicate and the first 20 individuals of the simulation.
#' 
#' \itemize{
...
#'  \tab \tab \tab \tab \cr
#'  \code{Tmax} \tab \tab 1 \tab \tab positive integer; the duration of the simulation (number of time steps). \cr
#'  \tab \tab \tab \tab \cr
#'  \code{NP}   \tab \tab 1 \tab \tab positive integer; the number of replicated populations. 
...
#'  \tab \tab \tab \tab \cr
#'  \code{NI}   \tab \tab 1 \tab \tab positive integer; the number of individuals in each sampled population. 
#'                          \code{NI} must be divisible by the number of higher-level groups (\code{NG}). \cr
#'  \tab \tab \tab \tab \cr                          
#'  \code{NT}   \tab \tab 1 \tab \tab positive integer; the number of traits for each individual. SQUID allows a maximum of 2 traits. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{NG}   \tab \tab 1 \tab \tab positive integer; the number of higher-level groups. \code{NG} must be lower than the number of individuals. \cr
#'  \tab \tab \tab \tab \cr
#'  
#'  \code{X1_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, 
#'                                             an environmental effect x1 will be added to the model equation.  \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_sto_state} \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE},
...
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X1_sto_shared}\tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X1_sto_V}     \tab \tab 1            \tab \tab numeric; the variance used to generate a normal distributed 
#'                                             stochastic environmental effect within the environmental effect x1.\cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_sto_autocor_state} \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, an autocorrelation effect will be 
#'                                                     added to the stochastic environemental effect within the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr                                                     
#'  \code{X1_sto_corr}          \tab \tab 0            \tab \tab numeric; the correlation value ranging from 0 to 1 
#'                                                     that characterizes the magnitude of the temporal autocorrelation between two consecutive time steps. \cr
#'  \tab \tab \tab \tab \cr                                                     
#'  \code{X1_lin_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, a linear trend will be added the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_lin_shared}    \tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X1_lin_intercept} \tab \tab 0            \tab \tab numeric; the intercept of the linear trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_lin_slope}     \tab \tab 1            \tab \tab numeric; the slope of the linear trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_lin_V}         \tab \tab 1            \tab \tab numeric; the variance used to generate different (unshared) linear trend effect for each individual within the environmnetal effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, a cyclic trend will be added the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_shared}    \tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr                                                 
#'  \code{X1_cyc_amplitude} \tab \tab 10           \tab \tab positive numeric; the amplitude of the cyclic trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_period}    \tab \tab 10           \tab \tab positive numeric; the period of the cyclic trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_Hshift}    \tab \tab 0            \tab \tab positive numeric; the horizontal shift of the cyclic trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_Vshift}    \tab \tab 0            \tab \tab positive numeric; the vertical shift of the cyclic trend included into the environmental effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X1_cyc_V}         \tab \tab 0            \tab \tab numeric; the variance used to generate different (unshared) cycluc trend effect for each individual within the environmnetal effect x1. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, 
#'                                             an environmental effect x2 will be added to the model equation.  \cr
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X2_sto_state} \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE},
...
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X2_sto_shared}\tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'                                             (i.e. a new stochastic environmental effect is generated for each individual).\cr
#'  \tab \tab \tab \tab \cr                                             
#'  \code{X2_sto_V}     \tab \tab 1            \tab \tab numeric; the variance used to generate a normal distributed 
#'                                             stochastic environmental effect within the environmental effect x2.\cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_sto_autocor_state} \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, an autocorrelation effect will be 
#'                                                     added to the stochastic environemental effect within the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr                                                     
#'  \code{X2_sto_corr}          \tab \tab 0            \tab \tab Numeric; the correlation value ranging from 0 to 1 
#'                                                     that characterizes the magnitude of the temporal autocorrelation between two consecutive time steps. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_lin_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, a linear trend will be added the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_lin_shared}    \tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr                                              
#'  \code{X2_lin_intercept} \tab \tab 0            \tab \tab Numeric; the intercept of the linear trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_lin_slope}     \tab \tab 1            \tab \tab Numeric; the slope of the linear trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_lin_V}         \tab \tab 1            \tab \tab Numeric; the variance used to generate different (unshared) linear trend effect for each individual within the environmnetal effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_state}     \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, a cyclic trend will be added the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_shared}    \tab \tab \code{TRUE}  \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr                                                 
#'  \code{X2_cyc_amplitude} \tab \tab 10           \tab \tab positive numeric; the amplitude of the cyclic trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_period}    \tab \tab 10           \tab \tab positive numeric; the period of the cyclic trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_Hshift}    \tab \tab 0            \tab \tab positive numeric; the horizontal shift of the cyclic trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_Vshift}    \tab \tab 0            \tab \tab positive numeric; the vertical shift of the cyclic trend included into the environmental effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X2_cyc_V}         \tab \tab 0            \tab \tab numeric; the variance used to generate different (unshared) cycluc trend effect for each individual within the environmnetal effect x2. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{X_Interaction}    \tab \tab \code{FALSE} \tab \tab logical; if \code{TRUE}, 
...
#'  \tab \tab \tab \tab \cr
#'  \code{B}          \tab \tab              \tab \tab  \cr
#'  \tab \tab \tab \tab \cr
#'  \code{Vind}       \tab \tab              \tab \tab  \cr
#'  \tab \tab \tab \tab \cr
#'  \code{Ve}         \tab \tab  0           \tab \tab  positive numeric; the measurement error variance. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{VG}         \tab \tab  0           \tab \tab  positive numeric; the high-level grouping variance. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{NR}         \tab \tab  1           \tab  \tab  positive integer; the number of records sampled in average per individual. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{Vhsi}       \tab \tab  0           \tab \tab  numeric (between 0 and 0.95); the among-individual variance in timing of sampling. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{NR_ind}     \tab \tab  \code{TRUE} \tab \tab  logical; if \code{TRUE}, individuals will be sampled the same number of times. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{NR_trait}   \tab \tab  \code{TRUE} \tab \tab  logical; if \code{TRUE}, traits within individuals will be sampled the same number of times. \cr
#'  \tab \tab \tab \tab \cr
#'  \code{ST_ind}     \tab \tab  \code{TRUE} \tab \tab  logical; if \code{TRUE}, individuals will be sampled at the same time.\cr
#'  \tab \tab \tab \tab \cr
#'  \code{ST_trait}   \tab \tab  \code{TRUE} \tab \tab  logical; if \code{TRUE}, traits within individuals will be sampled at the same times. \cr
#'  \tab \tab \tab \tab \cr
#'  \strong{Parameter name} \tab \tab \strong{Default value} \tab \tab \strong{Description}
#' }
#' 
#' @seealso \code{\link{runSQUIDapp}} to run the SQUID app which includes detailed documentation on the SQUID model and its sampling design. 
#'         
#' @examples                                                                                                                             
...
#' @export
#' 
runSQUIDfct <- function(input=list(), plot=FALSE, module=NULL, X_previsualization=NULL){ 
