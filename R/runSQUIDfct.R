...
#'                       If this is your first experience with SQUID, we highly recommend to start with the SQUID app in order to learn and get more familiarized with the SQUID model (use the function \code{\link{runSQUIDapp}}).
#' 
...
#'
#' @return
#' list that includes a \code{data.frame} of the full data generated, a \code{data.frame} 
