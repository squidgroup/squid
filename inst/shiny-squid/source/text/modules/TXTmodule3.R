...
Mod3Step1_txt <- list(
  ...
  "intro"      = paste("<b>Introduction:</b> In the previous module (Basic lessons about variance), we partitioned phenotypic variance 
                  ...
                  caused by measurement error, $V_",NOT$error,"$, and variance caused by the environment, $V_{",EQ3$mean1," ",EQ2$env1,"}$). 
                  In the final step of that module, we illustrated how measurement of the environment 
  ...
  "exercise"   = paste("<b>Exercise:</b> As in previous simulations, we will generate a new group of 
                  individuals, with phenotypic variation generated by measurement error ($V_",NOT$error,"$), 
                  individual differences ($V_",NOT$devI,"$), and the impact of the environment ($V_{",EQ3$mean1," ",EQ2$env1,"}$).", sep=""),
  "para1"      = paste("As before, you can set $V_",NOT$error,"$, $V_",NOT$devI,"$ and $V_{",EQ3$mean1," ",EQ2$env1,"}$, and for this module, $V_{",EQ3$mean1," ",EQ2$env1,"}$ can be greater than 0.
                  Note that for this module, the total variance ($V_",NOT$total,"$) is not restrained to 1 anymore.", sep=""),
  ...
  "para3"      = "You also must enter parameters for variance in the sampling of timing within and among individuals. 
                  For this simulation, the total number of expressions of the phenotype from which you can
                  sample is fixed at 100. 
                  While you can vary the number of individual samples taken, for this module to effectively 
                  illustrate the issues with sampling, the number of samples must be much less than 100. 
  ...
  "para8"      = paste("The above should show that if the unmeasured environment changes over time AND there is 
                  among-individual variance in sampling, then some of the unknown $V_{",EQ3$mean1," ",EQ2$env1,"}$ is placed into 
  ...
  "para9"      = paste("This exercise demonstrates that if there is among-individual variance in timing of sampling, then estimates 
...
Mod3Step2_txt <- list(    
  ...
  "exercise"   = paste0("<b>Exercise:</b> As in Step 1, we will generate a new group of individuals, with phenotypic 
                  ...
                  impact of the environment ($V_{",EQ3$mean1," ",EQ2$env1,"}$)."),
  ...
  "para6"      =  paste0("The results of any given simulation may vary, but the overall picture that emerges 
                  if you do several simulations should be that your estimates are better
                  when $V_",NOT$error,"$ is small, as you measure each 
                  individual more often and your sampling time increasingly similarl among individuals."), 
  "para7"      =  paste0("Did you simulate a population where the environment is not shared among individuals? 
                  ...
                  our estimate of $V_",NOT$devI,"$ is too high. To understand, let’s return to the definitions of 
                  the variance components: We defined $V_",NOT$devI,"$ as the variance among individuals 
                  ...
                  the environment is autocorrelated and differs among individuals, apparent individual 
                  differences arise because individuals are in different environments not because they 
                  entered the time period of phenotypic expression differing in their phenotype (note: You may 
                  be thinking that since individuals in the real world partially choose their environment then their 
