fullmodelTxt <- list(
  ...
  "fullModelSbyS_intro_1"     = "The last module of SQuID (module 11) allows the user to generate data sets of 
  ...
  "modelEquation_5"     = paste("Let's now go to the end of the equation, where we find the error $",EQ$error.1,"$. At the left of the 
                          error term we have $",EQ$group.1,"$ that represents the deviation from the population average of 
  ...
  "groupingNerror"      = paste("The high-level grouping term ($",NOT$groupV,"$) is generated from 
                          ...
                          and the error term ($",NOT$error,"$) from a normal distribution 
  ...
  "inputEnvironment_5"    = "Furthermore, below each environmental option a graph of the general environmental 
  ...
  "inputPhenDesign"      = "The section below allows you to enter all the information on the variance components 
                            ...
                            have the option to add some measurement errors and grouping variance.
                            Please pay attention that in the matrix below, the <b>correlation</b> between each components 
