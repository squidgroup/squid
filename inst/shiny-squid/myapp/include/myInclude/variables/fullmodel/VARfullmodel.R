...
#   ),
  ...
  "Drec_Ind"  = list( "label"     = "Same among individuals",
  ...
  "Drec_Trait"  = list( "label"     = "Same among traits within individuals",
  ...
  "Dtime_Ind"  = list( "label"     = "Same among individuals",
  ...
  "Dtime_Trait"  = list( "label"    = "Same among traits within individuals",
