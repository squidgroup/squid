...
Mod3Step1_txt <- list(
  ...
  "para1"      = paste("As before, you can set $V_",NOT$error,"$, $V_",NOT$devI,"$ and $V_{",EQ3$mean1," ",EQ2$env1,"}$, but remember that 
                  these must add up to 1 and for this module, $V_{",EQ3$mean1," ",EQ2$env1,"}$ must be greater than 0.", sep=""),
