...
UImodelDescription <- function(){
  
  myModelEquationY <- paste("$$", EQ$phen.1  , "=",
  ...
  myModelEquationZ <- paste("$$", EQ$phen.2  , "=",
        ...
        tabPanel("Simulation model",           
          ...
          p(HTML('<figure>
                  ...
                  <figcaption><b>Figure 1:</b> example of 3 environmental effects. 
                                          (Left) Linear trend with some randomness. 
                                          (Middle) Cyclic pattern with linear trend and some randomness. 
                                          (Right) Autocorrelation of 0.7 added to random values.</figcaption>
                  </figure>')
            ),
